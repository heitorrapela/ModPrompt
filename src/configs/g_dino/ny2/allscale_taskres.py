...
class_name = ("bathtub", "bed", "bookshelf", "box", "chair", "counter", "desk", "door", "dresser", "garbage bin", "lamp", "monitor", "night stand", "pillow", "sink", "sofa", "table", "television", "toilet")
...
model = dict(
    ...
    fft = 1, hft = 0, use_task_res = 1, img_prompt='allscale',
    prompt_size=30,
...
test_pipeline = [
    dict(type='LoadImageFromFile', backend_args=_base_.backend_args),
    dict(type='FixScaleResize', scale=(640, 480), keep_ratio=True),
    dict(type='LoadAnnotations', with_bbox=True),
    dict(
        type='PackDetInputs',
        meta_keys=('img_id', 'img_path', 'ori_shape', 'img_shape',
...
val_dataloader = dict(
    ...
    dataset=dict(data_root=data_root,
        ...
        pipeline=test_pipeline, return_classes=True))
test_dataloader = val_dataloader

val_evaluator = dict(ann_file='data/nyu_v2/test_gt_box.json')
