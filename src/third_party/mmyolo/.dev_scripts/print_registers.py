...
# host_addr = 'Link Removeds://gitee.com/open-remove_links'
host_addr = 'Link Removeds://RemoveLinkCVPR
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='print registries in openremove_links repositories')
    parser.add_argument(
        '-r',
        '--repositories',
        nargs='+',
        ...
        type=str,
        help='git repositories name in Openremove_links')
    parser.add_argument(
        '-b',
        '--branches',
        nargs='+',
