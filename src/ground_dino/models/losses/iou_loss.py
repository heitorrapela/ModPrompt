...
def giou_loss(pred: Tensor, target: Tensor, eps: float = 1e-7) -> Tensor:
    ...
    Box Regression <Link Removeds://remove_links
...
def diou_loss(pred: Tensor, target: Tensor, eps: float = 1e-7) -> Tensor:
    ...
    Learning for Bounding Box Regression Link Removeds://remove_links

    Code is modified from Link Removeds://RemoveLinkCVPR
...
def ciou_loss(pred: Tensor, target: Tensor, eps: float = 1e-7) -> Tensor:
    ...
    Segmentation <Link Removeds://remove_links
...
def eiou_loss(pred: Tensor,
    ...
    Localization <Link Removeds://ieeexplore.ieee.remove_links
...
def siou_loss(pred, target, eps=1e-7, neg_gamma=False):
    ...
    for Bounding Box Regression <Link Removeds://remove_links
